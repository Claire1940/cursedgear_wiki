...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Cursed Gear Wiki',
    description: 'Cursed Gear Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our wrestling game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Cursed Gear Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Cursed Gear Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including official Cursed Gear platforms, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Cursed Gear Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or Monad Studios West. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@cursedgear.wiki</a>
            </p>
            <p>
