...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Cursed Gear Wiki - Your Ultimate Wrestling Game Resource',
    description: 'Learn about Cursed Gear Wiki, a community-driven resource hub providing comprehensive guides, roster info, ratings, locker codes, and strategies for the Cursed Gear game.',
    keywords: [
      'about Cursed Gear Wiki',
      'Cursed Gear community',
      'wrestling game wiki',
      'game resource hub',
      'Cursed Gear team',
    ],
    ...
    openGraph: {
      ...
      siteName: 'Cursed Gear Wiki',
      title: 'About Cursed Gear Wiki',
      description: 'Learn about our mission to provide the best Cursed Gear game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Cursed Gear Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Cursed Gear Wiki',
      description: 'Learn about our mission to provide the best Cursed Gear game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Cursed Gear
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Cursed Gear Wiki</h2>
            <p>
              Cursed Gear Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Cursed Gear wrestling game. We are a community-driven platform that provides the latest locker codes,
            ...
            <p>
              ...
              Cursed Gear Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Cursed Gear players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Cursed Gear Wiki as the <strong>go-to destination</strong> for every Cursed Gear player seeking
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Locker Codes</h3>
              <p className="text-slate-300">
                Regularly updated lists of active locker codes to unlock free rewards, VC, and exclusive items.
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">📊</div>
              <h3 className="text-xl font-semibold text-white mb-2">Roster & Ratings</h3>
              <p className="text-slate-300">
                Comprehensive roster lists ranking superstars by overall ratings and attributes.
                Make informed decisions about which wrestlers to use in your matches.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🧮</div>
              <h3 className="text-xl font-semibold text-white mb-2">Match Types & Arenas</h3>
              <p className="text-slate-300">
                Interactive tools to explore match types, compare arenas, and plan your custom matches
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Your one-stop encyclopedia for all things Cursed Gear.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                German, French, Japanese, Arabic, and Korean.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Cursed Gear Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
            ...
            <ul>
              ...
              <li><strong>Meta shifts:</strong> We track competitive play and update ratings based on real performance data</li>
            </ul>
            <p>
              <strong>Want to contribute?</strong> Whether you've discovered a new strategy, found a locker code before anyone else,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Cursed Gear Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Cursed Gear as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Cursed Gear mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Cursed Gear Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with Roblox Corporation or Monad Studios West.
            </p>
            <p>
            ...
            <p>
              Cursed Gear Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@cursedgear.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@cursedgear.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@cursedgear.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@cursedgear.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest locker codes, guides, and Cursed Gear news.
