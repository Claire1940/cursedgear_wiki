...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Cursed Gear Wiki',
    description: 'Copyright and intellectual property information for Cursed Gear Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Cursed Gear Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Cursed Gear Wiki',
      description: 'Copyright and intellectual property information for Cursed Gear Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Cursed Gear Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Cursed Gear Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Cursed Gear Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Cursed Gear Wiki.
            </p>
            ...
            <p>
              ...
              Cursed Gear Wiki<br />
              Email: <a href="mailto:dmca@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cursedgear.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Cursed Gear Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Cursed Gear Wiki (cursedgear.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cursedgear.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cursedgear.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cursedgear.wiki</a>
            </p>
            <p>
